...
async function testCrud() {
  ...
  const questionId = await createQuestion({ id: 2, fichierId: 1, titre: 'Comment évalueriez-vous notre service ?', type: 'choix_multiple', options: ['Excellent', 'Bon', 'Moyen', 'Mauvais'] });
